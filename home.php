...
<section class="py-0 ">
    <div class="container">
        <div class="row">
            <div class="col-lg-2 px-1 border-right text-sm position-sticky filter">
                <h3 style="padding-top: 30px; color:azure"><b>Brands</b></h3>
                <ul class="list-group">
                    ...
                    ?>
                        <li class="list-group-item list-group-item-action" style="background-color: #acc5dc;">
                            <div class="icheck-primary d-inline">
            ...
            <div class="col-lg-10 py-2">
                ...
                <div class="container px-4 px-lg-5 mt-5">
                    <div class="row gx-4 gx-lg-4 row-cols-md-3 row-cols-xl-4 " id="product">
                        <?php
                        $where = "";
                        if (count($brands) > 0)
                        ...
                        ?>
                            <div class="col mb-5 product-cart">
                                <a class="card product-item text-reset text-decoration-none" href=".?p=view_product&id=<?php echo md5($row['id']) ?>">
                                    <!-- Product image-->
                                    <div class="overflow-hidden shadow product-holder" style="border-radius: 20px">
